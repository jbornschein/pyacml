/* Generated by Cython 0.10.3 on Sun Sep 19 15:26:35 2010 */
...
#endif
#include <math.h>
#define __PYX_HAVE_API__pyacml__vm
#include "acml_mv.h"
#include "stdlib.h"
...
/* Module declarations from pyacml.vm */



/* Implementation of pyacml.vm */
...
/* "/home/bornschein/src/pyacml/pyacml/vm.pyx":10
 * 
 * 
...
static PyObject *__pyx_pf_6pyacml_2vm_vdexp(PyObject *__pyx_self, PyObject *__pyx_v_arr); /*proto*/
static PyObject *__pyx_pf_6pyacml_2vm_vdexp(PyObject *__pyx_self, PyObject *__pyx_v_arr) {
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_arr), __pyx_ptype_5numpy_ndarray, 1, "arr", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(__Pyx_GetBuffer_nn___pyx_t_5numpy_float64_t((PyObject*)__pyx_v_arr, &__pyx_bstruct_arr, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_bstride_0_arr = __pyx_bstruct_arr.strides[0];
  __pyx_bshape_0_arr = __pyx_bstruct_arr.shape[0];

  /* "/home/bornschein/src/pyacml/pyacml/vm.pyx":11
 * 
 * def vdexp(np.ndarray[np.float64_t] arr):
 *     cdef np.ndarray[np.float64_t] out = np.empty_like(arr)             # <<<<<<<<<<<<<<
 *     cdef int n = arr.shape[0]
 ...
 */
  ...
  __pyx_2 = PyObject_GetAttr(__pyx_1, __pyx_kp_empty_like); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_1 = PyTuple_New(1); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  Py_INCREF(__pyx_v_arr);
  PyTuple_SET_ITEM(__pyx_1, 0, __pyx_v_arr);
  __pyx_3 = PyObject_Call(__pyx_2, ((PyObject *)__pyx_1), NULL); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  Py_DECREF(((PyObject *)__pyx_1)); __pyx_1 = 0;
  if (!(__Pyx_TypeTest(__pyx_3, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_1 = ((PyArrayObject *)__pyx_3);
  if (unlikely(__Pyx_GetBuffer_nn___pyx_t_5numpy_float64_t((PyObject*)__pyx_t_1, &__pyx_bstruct_out, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0) == -1)) {
    __pyx_v_out = ((PyArrayObject *)Py_None); Py_INCREF(Py_None); __pyx_bstruct_out.buf = NULL;
  ...
  __pyx_t_1 = 0;
  __pyx_v_out = ((PyArrayObject *)__pyx_3);
  __pyx_3 = 0;

  /* "/home/bornschein/src/pyacml/pyacml/vm.pyx":12
 * def vdexp(np.ndarray[np.float64_t] arr):
 *     cdef np.ndarray[np.float64_t] out = np.empty_like(arr)
 *     cdef int n = arr.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_n = (((PyArrayObject *)__pyx_v_arr)->dimensions[0]);

  /* "/home/bornschein/src/pyacml/pyacml/vm.pyx":14
 *     cdef int n = arr.shape[0]
 * 
 *     vrda_exp(n, <double*>arr.data, <double*>out.data)             # <<<<<<<<<<<<<<
 *     return out
 * 
 */
  vrda_exp(__pyx_v_n, ((double *)((PyArrayObject *)__pyx_v_arr)->data), ((double *)__pyx_v_out->data));

  /* "/home/bornschein/src/pyacml/pyacml/vm.pyx":15
 * 
 *     vrda_exp(n, <double*>arr.data, <double*>out.data)
 *     return out             # <<<<<<<<<<<<<<
 * 
 */
  ...
  __Pyx_AddTraceback("pyacml.vm.vdexp");
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_arr);
...
static struct PyMethodDef __pyx_methods[] = {
  {"vdexp", (PyCFunction)__pyx_pf_6pyacml_2vm_vdexp, METH_O, 0},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initvm(void); /*proto*/
PyMODINIT_FUNC initvm(void)
#else
PyMODINIT_FUNC PyInit_vm(void); /*proto*/
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("vm", __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  /* "/home/bornschein/src/pyacml/pyacml/vm.pyx":2
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
